...
export default class ViewFortnightlyProduct extends React.Component {
  constructor(props){
    super(props);
    this.state = {
    }
    ...
    return(
      ...
      <View>
        ...
        <View style={{flexDirection:'row',marginBottom:20}}>
          ...
          <View style={{flex:0.3}}>
            <Text style={{fontSize:16}}>Day {this.props.productData.fortnightlyDay1} & {this.props.productData.fortnightlyDay2}</Text>
          </View>
        </View>
