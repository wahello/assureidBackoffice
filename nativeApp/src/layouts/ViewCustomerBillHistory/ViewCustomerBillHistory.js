...
export default class ViewCustomerBillHistory extends React.Component {
  constructor(props) {
    super(props);
    let name = "";
  ...
  render() {
    ...
    const tableHead = ['Month', 'Bill Amount', 'Paid Amount','Payment Mode','Payment Date' ];
    const tableData = [
      ['August', 'Rs. 600', 'Rs. 620','Cash','14-09-2017'],
      ['September', 'Rs. 600', 'Rs. 620','Cash','14-09-2017'],
      ['October', 'Rs. 600', 'Rs. 620','Cash','14-09-2017'],
      ['November', 'Rs. 600', 'Rs. 620','Cash','14-09-2017'],
      ['December', 'Rs. 600', 'Rs. 620','Cash','14-09-2017'],
    ];
        ...
        >
          ...
          >
            ...
            >
              ...
              >
              <View style={{flex:1}}>
                <Text style={{textAlign:'center' }}>View History</Text>
              </View>
