...
import { Dropdown } from 'react-native-material-dropdown';
 ...
 export default class ExtraReduced extends React.Component {
  constructor(props){
    super(props);
    let name ="";
  ...
  render(){
    ...
    const tableHead = ['Line Number', 'Customer Nick Name', 'Start Date ','End Date'];
    const tableData = [
      ['145 shakti House', 'Mr Bakshi', '23-01-2018','24-01-2018'],
      ['145 shakti House', 'Sharmaji', '23-01-2018','24-01-2018'],
      ['145 shakti House', 'Mr Bakshi','23-01-2018','24-01-2018'],
      ['145 shakti House', 'Sharmaji','23-01-2018','24-01-2018'],
      ['145 shakti House', 'Mr Bakshi', '23-01-2018','24-01-2018'],
      ['145 shakti House', 'Sharmaji','23-01-2018','24-01-2018'],
                    ...
                    <Row data={tableHead} style={styles.head} textStyle={styles.headText}/>
                      {
                        tableData.map((data, i) => (
                          <TouchableOpacity key={i}  onPress={()=>navigate('ExtraReducedDetails')}>
