...
export default class ExtraReducedSelect extends React.Component {
  constructor(props) {
    super(props);
    let name = "";
    ...
    this.state = {
      ...
      isDifferentProductVisible: false
    };
  ...
  setVisible = () =>{
    this.setState({
      isDifferentProductVisible: !this.state.isDifferentProductVisible
    });
    console.log(this.state.isDifferentProductVisible);
}
  _toggleModal1 = () =>
  ...
  render() {
    ...
    const tableHead = ["Subscriptions", "Quantity"];
    const tableHead2 = ["Product", "Language", "Type"];
    const tableData2 = [
      ["Sakal", "Marathi", "Daily"],
      ["Sakal", "Marathi", "Daily"],
      ["Sakal", "Marathi", "Daily"],
        ...
        >
          ...
          >
            ...
            >
              ...
              <Header
                centerComponent={{
                  text: "Add Extra / Reduced Product",
                ...
                innerContainerStyles={{ marginTop: 0, paddingTop: 0 }}
              />
              <Text style={{textAlign:'center', paddingHorizontal:20,paddingTop:20}}>Add Extra / Reduced Product</Text>
              ...
              <View style={{ padding: 10 }}>
                ...
                {this.state.isDifferentProductVisible ? (
                  <View style={{ padding: 10, justifyContent: "center" }}>
                    <Table>
                      <Row
                        data={tableHead2}
