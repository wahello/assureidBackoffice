...
TouchableOpacity, TextInput, View,  BackHandler,
 Image, BackAndroid, findNodeHandle, DrawerLayoutAndroid,Alert} from 'react-native';
...
import Menu from '../../components/Menu/Menu.js';
 ...
 export default class ViewCustomerBillDetails extends React.Component {
  constructor(props){
    super(props);
    let name ="";
  ...
  closeAccount = () =>{
    Alert.alert(
      '','Account been close successfully!'
    )
  }
            ...
            <Header
              ...
              <View style={{padding:10}}>
                <View style={{flexDirection:'row',marginLeft:-4}}>
                  ...
                  <Button onPress={this.closeAccount} textStyle={{textAlign:'center'}} buttonStyle={styles.button} title="COLLECT & CLOSE"/>
                </View>
              </View>
            </ScrollView>
          </View>
