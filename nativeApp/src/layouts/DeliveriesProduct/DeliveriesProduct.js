            ...
            <Header
              ...
              <View style={{padding:10}}>
                <View style={{flexDirection:'row'}}>
                  ...
                  <Button onPress={()=>navigate('DeliveriesProduct')}  textStyle={{textAlign:'center'}} buttonStyle={styles.button} title="DELIVERY BY PRODUCT"/>
                </View>
                ...
                <View style={{flexDirection:'row',paddingTop:20}}>
                  ...
                  <View style={{borderRadius: 0,
                                ...
                                borderColor: '#f7ac57',padding:8,
                                marginRight:13}}>
                    <Text style={{fontSize:12}}>REDUCED</Text>
                    <Text style={{fontSize:12}}>0 users</Text>
                  </View>
                  </TouchableOpacity>
                </View>
                ...
                <TouchableOpacity onPress={()=>navigate('DeliveriesQuantity2')}>
                ...
                <View style={{borderRadius:3,borderWidth:1,borderColor:'#aaa',height:168,marginBottom:10}}>
                  <View style={{height:120,borderTopWidth:5,borderColor:'#f7ac57'}}>
                    <View style={{flexDirection:'row',alignSelf:'center',padding:15}}>
                      <Text style={{textAlign:'center'}}>Sakal</Text>
                    </View>
                    <View style={{flexDirection:'row',alignSelf:'center'}}>
                      <View style={{flexDirection:'column',paddingRight:15}}>
                        <Text style={{textAlign:'center'}}>Today Quantity</Text>
                        <Text style={{textAlign:'center'}}>130</Text>
                      </View>
                       <View style={{flexDirection:'column',paddingLeft:15}}>
                        <Text style={{textAlign:'center'}}>Today Quantity</Text>
                        <Text style={{textAlign:'center'}}>128</Text>
                      </View>
                    </View>
                  </View>
                    <View style={{height:46,backgroundColor:'#f3ebe8',borderTopWidth:1,borderColor:'#aaa'}}>
                      <View style={{alignSelf:'center',padding:12}}>
                        <Text>Total Customers:120</Text>
                      </View>
                    </View>
                </View>
                </TouchableOpacity>
                ...
                <View style={{borderRadius:3,borderWidth:1,borderColor:'#aaa',height:168}} >
                  <View style={{height:120,borderTopWidth:5,borderColor:'#f7ac57'}}>
                    <View style={{flexDirection:'row',alignSelf:'center',padding:15}}>
                      <Text style={{textAlign:'center'}}>Loksatta</Text>
                    </View>
                    <View style={{flexDirection:'row',alignSelf:'center'}}>
                      <View style={{flexDirection:'column',paddingRight:15}}>
                        <Text style={{textAlign:'center'}}>Today Quantity</Text>
                        <Text style={{textAlign:'center'}}>157</Text>
                      </View>
                       <View style={{flexDirection:'column',paddingLeft:15}}>
                        <Text style={{textAlign:'center'}}>Today Quantity</Text>
