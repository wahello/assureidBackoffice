...
import { Dropdown } from 'react-native-material-dropdown';
 ...
 export default class CustomerHoliday extends React.Component {
  constructor(props){
    super(props);
    let name ="";
  ...
  render(){
    ...
    const tableHead = ['Line Number', 'Customer Nick Name', 'Customer Name'];
    const tableData = [
      ['145 shakti House', 'Mr Bakshi', 'Darshan Bakshi'],
      ['145 shakti House', 'Sharmaji', 'Ashish Sharma'],
      ['145 shakti House', 'Mr Bakshi', 'Darshan Bakshi'],
      ['145 shakti House', 'Sharmaji', 'Ashish Sharma'],
      ['145 shakti House', 'Mr Bakshi', 'Darshan Bakshi'],
      ['145 shakti House', 'Sharmaji', 'Ashish Sharma'],
