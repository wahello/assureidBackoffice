...
import Menu from '../../components/Menu/Menu.js';
 ...
 export default class ViewBill extends React.Component {
  ...
  handleView(){
    this.props.navigation.navigate('ViewBillLine');
  }
  componentDidMount(){
         ...
         <View style={{ flex: 1, backgroundColor: '#FFF',borderWidth:0,padding:0}}>
          <ScrollView createContainerStyle={{marginBottom: 25,borderWidth:0,margin:0}}>
            <Header
              ...
              />
              <Header
                centerComponent={{ text: "View Bill", style:{ color: '#fff',alignSelf:'center'} }}
                leftComponent={
              ...
              <View style={{padding:10}}>
                <View style={{flexDirection:'row',marginLeft:-4}}>
                  <Button textStyle={{textAlign:'center'}} buttonStyle={styles.button} title="VIEW ALL BILLS"/>
                  <Button textStyle={{textAlign:'center'}} buttonStyle={styles.button} title="SEND ALL BILLS"/>
                </View>
