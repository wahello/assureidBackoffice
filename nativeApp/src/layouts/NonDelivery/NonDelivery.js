...
import { Dropdown } from 'react-native-material-dropdown';
 ...
 export default class NonDelivery extends React.Component {
  constructor(props){
    super(props);
    let name ="";
              ...
              <View style={{padding:10}}>
                ...
                <View style={{flexDirection:'row',paddingTop:20}}>
                  ...
                  <View style={{borderRadius: 0,
                    ...
                    <Text style={{fontSize:12, color:'#fff'}}>NON DELIVERIES</Text>
                    <Text style={{fontSize:12, color:'#fff'}}>23 users </Text>
                  </View>
                  </TouchableOpacity>
                ...
                <TouchableOpacity onPress={()=>navigate('DeliveriesDate')}>
                  ...
                  <View style={{height:120,borderTopWidth:5,borderColor:'#f7ac57'}}>
                    ...
                    <View style={{flexDirection:'row',alignSelf:'center'}}>
                      <View style={{flexDirection:'column',paddingRight:15}}>
                        <Text style={{textAlign:'center'}}>Today Non-Deliveries</Text>
