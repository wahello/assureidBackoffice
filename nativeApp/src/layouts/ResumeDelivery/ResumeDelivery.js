...
import { Dropdown } from 'react-native-material-dropdown';
 ...
 export default class ResumeDelivery extends React.Component {
  constructor(props){
    super(props);
    let name ="";
          ...
          <ScrollView createContainerStyle={{marginBottom: 25,borderWidth:0,margin:0}}>
            <Header
              ...
              <View style={{padding:10}}>
                ...
                <View style={{flexDirection:'row',paddingTop:20}}>
                 <TouchableOpacity onPress={()=> navigate('NonDelivery')}>
                  ...
                  <View style={{borderRadius: 0,
                    ...
                    <Text style={{fontSize:12,color:'#fff'}}>RESUME</Text>
                    <Text style={{fontSize:12,color:'#fff'}}>10 users </Text>
                  </View>
                   </TouchableOpacity>
                ...
                <TouchableOpacity onPress={()=>navigate('DeliveriesDate2')}>
                  ...
                  <View style={{height:120,borderTopWidth:5,borderColor:'#f7ac57'}}>
                    ...
                    <View style={{flexDirection:'row',alignSelf:'center'}}>
                      <View style={{flexDirection:'column',paddingRight:15}}>
                        <Text style={{textAlign:'center'}}>Today Resume Deliveries</Text>
