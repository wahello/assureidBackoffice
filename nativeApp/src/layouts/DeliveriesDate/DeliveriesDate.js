...
export default class DeliveriesDate extends React.Component {
  constructor(props) {
    super(props);
    let name = "";
          ...
          >
            ...
            >
              ...
              <Header
                ...
                innerContainerStyles={{ marginTop: 0, paddingTop: 0 }}
              />
              <Text style={{paddingHorizontal:20,paddingTop:20}}>Line 145, Shakti House</Text>
                ...
                <Card containerStyle={styles.card}>
                  <View style={styles.cardHeader}>
                    <View style={{paddingHorizontal:15, paddingVertical:10, flex:1 }}>
                      <Text style={{fontSize:25}}>Mr. Bakshi</Text>
                      <Text>+91 7387383275</Text>
                      <Text>Cash Mode</Text>
                    </View>
                    <View style={{flex:1, paddingHorizontal:15}}>
                      <Text>Subsctiptions</Text>
                    </View>
                    <View style={{flex:1, flexDirection:'row',paddingHorizontal:5, paddingTop: 5}}>
                      <View style={{paddingHorizontal: 15, paddingVertical: 5}}>
                        <Image style={{width:25, height:25, borderRadius: 15  }} resizeMode="stretch"
                  ...
                  >
                    <View style={{flex:1,paddingVertical:10,paddingHorizontal:15}}>
                      <Text style={{textAlign:'center'}}>21-01-2018 to 31-01-2018</Text>
                    </View>
                  </View>
                </Card>
              </TouchableOpacity>
