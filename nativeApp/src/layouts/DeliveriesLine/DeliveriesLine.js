...
import HeaderDy  from '../../components/HeaderDy/HeaderDy.js';
 ...
 export default class DeliveriesLine extends React.Component {
  constructor(props){
    super(props);
    let name ="";
         ...
         <View style={{ flex: 1, backgroundColor: '#FFF',borderWidth:0,padding:0}}>
          <ScrollView createContainerStyle={{marginBottom: 25,borderWidth:0,margin:0}}>
            <Header
              ...
              />
            <HeaderDy goBack={goBack} headerTitle="Deliveries"
                />
              <View style={{padding:10}}>
                <View style={{flexDirection:'row',}}>
                  <Button onPress={()=>navigate('DeliveriesLine')} textStyle={{textAlign:'center'}} buttonStyle={styles.button} title="DELIVERY BY LINE"/>
                ...
                <TouchableOpacity onPress={()=>navigate('Deliveries')}>
                  ...
                  <View style={{height:120,borderTopWidth:5,borderColor:'#f7ac57'}}>
                    ...
                    <View style={{flexDirection:'row',alignSelf:'center'}}>
                      <View style={{flexDirection:'column',paddingRight:15}}>
                        <Text style={{textAlign:'center'}}>Today Customers</Text>
