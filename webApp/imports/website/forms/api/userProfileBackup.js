        ...
        'changeStatusMethod':function(userId,remark,verificationType,verificationId){
          ...
          // if(_id){
              if (verificationType == "permanentAddress") {
                ...
                console.log("verificationUniqueId",verificationUniqueId);
                // UserProfile.update(
                //     {'userId':userId, [verificationType+'.'+verificationUniqueId] : parseInt(verificationId)},
                //     { $set:{
                //         // [verificationType+'.'+verificationId+'.editStatus'] : "Block" , 
                //         // [verificationType+'.'+verificationId+'.verifiedStatus'] : "In Process" , 
