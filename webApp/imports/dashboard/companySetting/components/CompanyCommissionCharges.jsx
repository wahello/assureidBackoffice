...
class CompanyCommissionCharges extends TrackerReact(Component){
      ...
      <section className="NotificationContent">
        <div className="row">
          <div className="col-lg-10 col-lg-offset-1 col-md-10 col-md-offset-1 col-sm-12 col-xs-12 ">
            ...
            <h3 className="box-title">COMPANY COMMISSION CHARGES</h3>
            </div>
 ...
 EditCompanyCommissionCharges = createContainer((props)=>{
...
export default EditCompanyCommissionCharges;
